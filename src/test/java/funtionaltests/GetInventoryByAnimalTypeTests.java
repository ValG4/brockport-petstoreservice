...
/**
 * GetInventoryByAnimalTests class is used to do some testing with the petstore inventory.
 * The class is following the REST assured framework and needs to have the petstore application running to run the tests
 */
